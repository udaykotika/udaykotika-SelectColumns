...
public class Lab1Test {
    ...
    public void problem1Test(){
        //arrange
        Person person1 = new Person(1, "Steve", "Garcia");
        Person person2 = new Person(2,"Alexa", "Smith");
        Person person3 = new Person(3,"Steve","Jones");
        Person person4 = new Person(4, "Brandon", "Smith");
        Person person5 = new Person(5,"Adam","Jones");
        ...
        //assert
        Assert.assertEquals("The records in the resultset should match those that were inserted. "
                ,expectedResult, persons);
    }
